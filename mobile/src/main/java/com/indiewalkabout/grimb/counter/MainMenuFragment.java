...
public class MainMenuFragment extends YassBaseFragment implements View.OnClickListener, QuitDialog.QuitDialogListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Animation pulseAnimation = AnimationUtils.loadAnimation(getActivity(),(int)R.animator.button_pulse);
...
//                .start();
        ...
        Animation titleAnimation = AnimationUtils.loadAnimation(getActivity(), (int)R.animator.title_enter);
...
//                .start();
        ...
        Animation subtitleAnimation = AnimationUtils.loadAnimation(getActivity(), (int)R.animator.subtitle_enter);
